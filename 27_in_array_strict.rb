...
withinarr = false   #created a boolean variable as false
arr.each do |element| #iterate arr with the .each method
    if strict == true and element == string# if statement conditional if strict is true and element is equal to string boolean variable will be true
        withinarr = true
    
    

elsif #elsif strict is equal to false and element is equal to string with downcase boolean variable is equal to true
        strict == false and element.downcase == string.downcase
        withinarr = true
...
return withinarr
    ...
    # your code goes here
p in_array_strict?("HeLLo", ["hi", "howdy", "Hello"], true)# => false
p in_array_strict?("HeLLo", ["hi", "howdy", "Hello"], false)# => true
