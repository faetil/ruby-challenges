...
def sort(num_array)
    ...
    loop do
        ...
        (n -1).times do |item|
            if num_array [item] > num_array[item + 1]
                num_array[item], num_array[item + 1] = num_array[item + 1], num_array[item]
                swapped = true
            end 
        end
    ...
    #     (n - 1).times do |item|
    #         if num_array[item] > num_array[item + 1]
    #             num_array[item], array[item + 1] = num_array[item + 1], num_array[item]
    #             swapped = true
    #         end
    #     end
    # end
